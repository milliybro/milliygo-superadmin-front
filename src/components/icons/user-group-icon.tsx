...
const UsersGroupIcon: FC<SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg
    {...props}
  ...
  >
    ...
    />
    <path
      d="M17.7139 13C20.0808 13 21.9996 14.9188 21.9996 17.2857C21.9996 18.2325 21.2321 19 20.2853 19"
      stroke="currentColor"
      stroke-width="1.5"
      stroke-linecap="round"
      stroke-linejoin="round"
